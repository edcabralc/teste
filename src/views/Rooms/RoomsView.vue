            ...
            <section id="sobre" class="section">
                <div class="container reverse">
                    <div class="item-wrapper-image">
                        <img class="item-image" src="@/assets/images/acomodacoes/deluxe/luxo1.jpg" alt="Um quarto com cama de casal, espelho e quadro na parede" />
                    </div>
                    <div class="content-wrapper">
                        <div class="item-content-wrapper">
                            <img class="icon" src="@/assets/images/quarto.svg" alt="Ícone de um quarto" />
                            <h3 class="subtitle">Deluxe 02</h3>
                        </div>
                        <p class="paragraph">O mais completo no hotel tanto em termos de serviço como de acomodações. Um deck exclusivo com vista para o mar, a melhor vista do hotel.</p>
            ...
            <article class="home-reserva acomodacao">
                <div class="home-reserva-container">
                    ...
                    <div class="home-reserva-image">
                        <img src="@/assets/images/bell.png" alt="Uma mão tocando em um sino" />
                    </div>
                </div>
            </article>
        </main>
